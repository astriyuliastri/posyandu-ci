...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btnSelectImunisasi').click(function() {
            var id = $(this).data('id');
            var tgl_skrng = $(this).data('tgl_skrng');
            ...
            var bb = $(this).data('bb');
            var tb = $(this).data('tb');
            var imunisasi = $(this).data('imunisasi');
            var vit_a = $(this).data('vit_a');
            var ket = $(this).data('ket');

            $('#id_imunisasi').val(id);
            $('#tgl_skrng').val(tgl_skrng);
            $('#nik').val(nik);
            $('#nama_anak').val(nama);
            $('#tgl_lahir').val(tgl_lahir);
            $('#jenis_kelamin').val(jk);
            $('#bb').val(bb);
            $('#tb').val(tb);
            $('#imunisasi').val(imunisasi);
            $('#vit_a').val(vit_a);
            $('#ket').val(ket);

            $('#DataImunisasiModal').modal('toggle');
        });
