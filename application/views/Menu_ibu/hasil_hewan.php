...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Riwayat Vaksin Hewan</h6>
        </div>
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="col-xs-4 col-xs-offset-4 text-center">
                    ...
                    <?php if (!empty($keyword)) { ?>
                        <p style="color:Black"><b>Riwayat vaksin hewan peliharaan "<?= $keyword; ?>"</b></p>
                    <?php } ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="actionTable">
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $row) { ?>
                                                <tr>
                                                    <td><?= $row['tgl_skrng'] ?></td>
                                                    <th scope="row"><?= $row['nama_binatang'] ?></th>
