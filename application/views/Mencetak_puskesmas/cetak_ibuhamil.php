                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <form method="get" action="">
                                            ...
                                            <a class="btn btn-secondary" href="<?php echo base_url('mencetak/cetak_ibuhamil'); ?>">Reset Filter</a>
                                        </form>
                                        <hr />
                                            ...
                                            <table width="100%" class="table table-striped table-bordered table-hover" id="actionTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Usia Kandungan <br>(Sekarang)</th>
                                                        <th>Layanan</th>
                                                        <th>Ket</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    if (!empty($cetak_ibuhamil)) {
                                                        ...
                                                        foreach ($cetak_ibuhamil as $data) {
                                                            ...
                                                            echo "<td>" . $data->usia_kandungan_daftar . "</td>";
