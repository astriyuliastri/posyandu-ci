<div class="container">
   <div class="row">
      <div class="col">
         <h3 class="page-header">Kelola Berita</h3>
      </div>
   </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="#" class="form-horizontal" id="form">
               ...
               <div class="form-group row">
                  <div class="col">
                     <label for="featured" class="col-form-label">Berita Terbaru</label>
                  ...
                  <div class="col">
                     <label for="choice" class="col-form-label">Berita Terkini</label>
                  ...
                  <div class="col">
                     <label for="thread" class="col-form-label">Populer</label>
