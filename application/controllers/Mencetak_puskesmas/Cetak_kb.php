    ...
    public function index()
    {
        ...
        if (isset($_GET['filter']) && !empty($_GET['filter'])) { // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if ($filter == '1') { // Jika filter nya 1 (per tanggal)
                ...
                $title = 'Laporan Keluarga Berencana Tanggal ' . date('d-m-y', strtotime($tgl_skrng));
                ...
                $title = 'Laporan Keluarga Berencana Bulan ' . $nama_bulan[$bulan] . ' ' . $tahun;
                ...
                $title = 'Laporan Keluarga Berencana Tahun ' . $tahun;
            ...
            $title = 'Semua Laporan Keluarga Berencana';
        ...
        $this->load->view('mencetak_puskesmas/cetak_kb', $data);
    }
